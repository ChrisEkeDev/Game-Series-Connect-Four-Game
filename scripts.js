...
document.addEventListener('DOMContentLoaded', () => {
    ...
    for (let i = 0; i < squares.length; i++) {
        (function(index) {
            // Add a onclick event to each square in the grid
                ...
                if (squares[index + 7].classList.contains('taken')) {
                    if (squares[index].classList.contains('taken')) {
                        ...
                        if (currentPlayer === 1) {
                            ...
                            currentPlayer = 1;
                            displayCurrentPlayer.innerHTML = currentPlayer
                            // If the square below your currnet square is not taken, you cant go here
                        } else {
                            alert('cant go here')
                        }
                    }
    ...
    function endGame(winner) {
        ...
        switch(winner) {
            case 1: winningPlayer.textContent = 'Player One Wins!'; break;
            case 2: winningPlayer.textContent = 'Player Two Wins!'; break;
            default: break;
        };
